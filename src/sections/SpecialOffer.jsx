  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-6 lg:max-w-lg info-text">Navigate a realme of possibilities designed to fulfill your unique desires, surpassing the loftiest expactations. Your journey with us is nothing short of exceptional</p>
        <p/>
